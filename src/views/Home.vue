<template>
  <div class="home">
    <img alt="Vue logo" src="../assets/HHT_TEA_LEAF_VECTOR_480x480@2x.jpg" />
    <HelloWorld msg="Welcome to Healty Web" />
    <br><br><br><br><br><br>
        ...
        <div class="section-content">
            <div class="row">
                <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2">
                    ...
                    <img class="img-fluid img-cover" src="../assets/hero-1.jpg" />
                </div>
        ...
        <div class="section-content">
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                    <img src="../assets/testi-bg.jpg" alt="" class="img-fluid shadow w-100">
                </div>
            </div>
            <div class="row mt-5">
                <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                    <img src="../assets/hero-3.jpg" alt="" class="img-fluid shadow w-100">
                </div>
...
.header {
  ...
  padding: 24px;
  border-radius: 20px;
  border: 1px solid rgb(233, 218, 88);
  background: #f3cd88;
  margin-top: 100px ;
}
</style>
